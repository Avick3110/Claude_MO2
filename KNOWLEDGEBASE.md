...
| File | Load When |
|---|---|
| **KB_Tools.md** | Any session using MCP tools (always load) |
| **KB_SessionStrategy.md** | Sessions involving heavy tool use or multiple parallel MCP calls |
| **KB_ModDissection.md** | Before performing a mod dissection or full mod analysis |
