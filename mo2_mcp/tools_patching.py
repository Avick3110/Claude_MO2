                ...
                "records": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "set_fields": {"type": "object", "description": "Field name->value pairs. Supports aliases: Health, Magicka, Stamina (NPC), ArmorRating/Value/Weight (ARMO), Damage/Speed/Reach (WEAP). Also accepts Mutagen property paths like 'Configuration.HealthOffset'."},
                            ...
                            "add_keywords": {"type": "array", "items": {"type": "string"}, "description": "FormIDs of keywords to add"},
                            "remove_keywords": {"type": "array", "items": {"type": "string"}, "description": "FormIDs of keywords to remove"},
                            "add_spells": {"type": "array", "items": {"type": "string"}, "description": "FormIDs of spells to add (NPC)"},
                            "remove_spells": {"type": "array", "items": {"type": "string"}, "description": "FormIDs of spells to remove (NPC)"},
                            ...
                            "add_items": {"type": "array", "items": {"type": "object", "properties": {"reference": {"type": "string"}, "level": {"type": "integer"}, "count": {"type": "integer"}}, "required": ["reference"]}, "description": "Entries to add to leveled lists"},
                            "add_conditions": {"type": "array", "items": {"type": "object", "properties": {"function": {"type": "string", "description": "Mutagen condition function name (e.g. 'GetLevel', 'GetActorValue', 'GetGlobalValue')"}, "operator": {"type": "string", "description": "Comparison operator: ==, !=, <, <=, >, >=, or Mutagen enum name"}, "value": {"type": "number", "description": "ConditionFloat literal — compare against this value"}, "global": {"type": "string", "description": "ConditionGlobal FormID — compare against this Global (alternative to 'value'). Use with GetGlobalValue functions."}, "run_on": {"type": "string", "description": "Subject / Target / Reference / CombatTarget / LinkedReference / QuestAlias / PackageData / EventData (default: Subject)"}, "or_flag": {"type": "boolean", "description": "OR with the next condition (default: AND)"}}, "required": ["function"]}, "description": "Conditions to add (perks, spells, packages, magic effects, etc.)"},
                            "remove_conditions": {"type": "array", "items": {"type": "object", "properties": {"function": {"type": "string"}, "index": {"type": "integer"}}}, "description": "Conditions to remove by function name or index"},
                            "attach_scripts": {"type": "array", "items": {"type": "object", "properties": {"name": {"type": "string"}, "properties": {"type": "array", "items": {"type": "object", "properties": {"name": {"type": "string"}, "type": {"type": "string", "enum": ["Object", "Int", "Float", "Bool", "String", "Alias"], "description": "Alias type expects value as {quest: 'Plugin:FormID', alias_id: int}"}, "value": {}}}}}, "required": ["name"]}, "description": "Scripts to attach with typed properties (VMAD)"},
